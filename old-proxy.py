...
POINT_COSTS = {
    ...
    "gemini-2.5-flash-preview": {"base": 8, "per_1k_tokens": 2},
    "gemini-2.0-pro": {"base": 1500, "per_1k_tokens": 2},
    "gemini-2.5-pro-exp": {"base": 168, "per_1k_tokens": 13},
    ...
    "GPT-5": {"base": 241, "per_1k_tokens": 38},
    ...
    "Llama-3.3-70B-nitro" : {"base": 1, "per_1k_tokens": 0}
}
    ...
    for attempt in range(max_retries):
        ...
        try:
            async for partial in fp.get_bot_response(
                ...
                if time.time() - api_call_start_time > 150: # 60s timeout for the call itself
